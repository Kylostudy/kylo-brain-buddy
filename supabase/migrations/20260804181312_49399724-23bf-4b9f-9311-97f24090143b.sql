...
ALTER TABLE public.brain_task_queue ADD CONSTRAINT brain_task_queue_task_type_check CHECK (task_type = ANY (ARRAY[
  ...
  'stt_media_fetch','reddit_post','reddit_comment','linkedin_post','facebook_warmup'
]::text[]));