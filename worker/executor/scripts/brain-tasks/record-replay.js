...
async function runRecordReplay({ page, context, spec, creds, log }) {
  ...
  const PROFILE_RE = /\/(profile|profil|fiok|fiók|account|dashboard|my|settings|beallitasok|generalas|general|funkciok|funkciók|feladatok|feltoltes|feltöltés|olvasonaplo|olvasónapló|konyvtar|könyvtár|tanulas|tanulás)\b/i;
